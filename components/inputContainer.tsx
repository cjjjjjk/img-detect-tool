        ...
        return (
            <div>
                ...
                >
                    ...
                    />
                    <p className="text-gray-600">select folder</p>
                </div>
                    ...
                    <>
                        <div className="mt-4 flex flex-col gap-2 max-h-[70vh] overflow-y-auto px-3">
                            {currentFiles.map((file, idx) => (
                                <div
                                    key={startIndex + idx}
                                    className={`flex items-center justify-between cursor-pointer hover:bg-white/40 ${(startIndex + idx) == selectedImgIdx ? "border border-red-400" : ""}`}
